...
<!-- Hydration -->
Server side rendering gives the illusion of faster load times because the user will get the html before the js. So to maintain the illusion, you want to fill or "hydrate" your technically empty html with some js/react so the app actually works, but not have that hydration be noticeable at all. It should look as if nothing happened
...
<!-- This Point is important for interview question whhile looping array why indexing is important -->
